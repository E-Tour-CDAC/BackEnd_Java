...
CREATE TABLE `itinerary_master` (
  ...
  `day_no` int NOT NULL,
  `itinerary_detail` text NOT NULL,
  PRIMARY KEY (`itinerary_id`),
  UNIQUE KEY `category_id` (`category_id`,`day_no`),
  CONSTRAINT `fk_itinerary_category` FOREIGN KEY (`category_id`) REFERENCES `category_master` (`category_id`) ON DELETE CASCADE
...
INSERT INTO `itinerary_master` VALUES (1,1,1,'Arrival at Srinagar, Dal Lake shikara ride'),(2,1,2,'Gulmarg sightseeing and snow activities'),(3,2,1,'Arrival at Paris, Eiffel Tower visit');
